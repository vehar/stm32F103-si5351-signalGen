...
extern "C"
{
    ...
    constexpr int CLK0 = 0;
    constexpr int CLK2 = 2;

    struct ChannelConfig
    {
        int32_t frequency;  // Updated to int32_t for compatibility
        int32_t powerLevel; // Updated to int32_t for compatibility
        bool enabled;
    };
    ...
    typedef enum
    {
        DRIVE_STRENGTH_2MA = 0x00, //  ~ 2.2 dBm
        DRIVE_STRENGTH_4MA = 0x01, //  ~ 7.5 dBm
        DRIVE_STRENGTH_6MA = 0x02, //  ~ 9.5 dBm
        DRIVE_STRENGTH_8MA = 0x03, // ~ 10.7 dBm
        DRIVE_STRENGTH_OFF = 0x04
    ...
    int si5351_SetupOutput(uint8_t output, si5351PLL_t pllSource,
                           si5351DriveStrength_t driveStength, si5351OutputConfig_t *conf,
                           uint8_t phaseOffset);
